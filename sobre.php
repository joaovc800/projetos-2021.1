      ...
      <div class="container">
        <div class="row">
          <div class="col-6 col-sm-3">
            ...
            <p class="lead">Wit Solutions é uma empresa de tecnologia e informações que visa como objetivo principal
              manter a segurança de empresas com seus clientes através da web segurança com
              softwares avançados de fácil entendimento e implantação rápida e justa que cabe no seu
              bolso, suporte 24Hrs e compatível com todas as plataformas.</p>
          </div>
          <div class="col-6 col-sm-3">
            <h1>
              Nossa 
            <span class="text-muted">missão</span>
            </h1>
            <p class="lead">Trazer as melhores soluções aos problemas requeridos das empresas através da web
              segurança, utilizando de softwares avançados de fácil entendimento e rápida implantação
              com preços acessíveis e indisputáveis no mercado.</p>
          </div>
          <div class="col-6 col-sm-3">
            <h1>
              Nossa 
              <span class="text-muted">visão</span>
            </h1>
            <p class="lead">Tornar-se uma empresa de grande porte proporcionando as melhores experiências com a
              empresa contratante ao seu cliente final, visando ser a melhor empresa com uma
              interatividade única.</p>
          </div>
          <div class="col-6 col-sm-3">
            <h1>
              Nossos 
            ...
            <p class="lead">Manter a segurança e integridade de empresas com seus clientes através da web
              segurança, com suporte de 24Hrs em qualquer plataforma com os melhores profissionais
              disponíveis no mercado de IT (Inteligência & Tecnologia).</p>
          </div>
        </div>
      </div>
      </div>
